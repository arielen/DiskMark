...
int Global::getOutputColumnsCount() { return 80; }
...
QString Global::getBenchmarkButtonText(BenchmarkParams params, QString paramsLine) {
  ...
  if (paramsLine.isEmpty()) return text.arg("Q%1T%2").arg(params.Queues).arg(params.Threads);
  else return text.arg("(%1)").arg(paramsLine);
}
...
QString Global::getRWSequentialRead() { return QStringLiteral("read"); }
QString Global::getRWSequentialWrite() { return QStringLiteral("write"); }
QString Global::getRWSequentialMix() { return QStringLiteral("rw"); }
QString Global::getRWRandomRead() { return QStringLiteral("randread"); }
QString Global::getRWRandomWrite() { return QStringLiteral("randwrite"); }
QString Global::getRWRandomMix() { return QStringLiteral("randrw"); }
